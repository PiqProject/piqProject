...
public class SecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            "/api/v1/auth/login",
            "/api/v1/auth/reissue",
<<<<<<< HEAD:src/main/java/piq/piqproject/config/springsecurity/SecurityConfig.java
            "/api/v1/user/profiles",
=======
            "/api/v1/reviews",
>>>>>>> 9828f7a02314e9d4ed89c26ac1c0feb589387989:src/main/java/piq/piqproject/config/jwt/SecurityConfig.java
